...
* [Using Binary Authorization](#using-binary-authorization)
   ...
   * [Enforcing Attestations](#enforcing-attestations)
      * [Setting up the Necessary Variables](#setting-up-the-necessary-variables)
      * [Creating an Attestation Note](#creating-an-attestation-note)
      * [Creating a PGP Signing Key](#creating-a-pgp-signing-key)
      * [Registering the Attestor in the Binary Authorization API](#registering-the-attestor-in-the-binary-authorization-api)
      * ["Signing" a Container Image](#signing-a-container-image)
      * [Running an Image with Attestation Enforcement Enabled](#running-an-image-with-attestation-enforcement-enabled)
